...
if xrandr --query | grep "HDMI1 connected"; then
  if xrandr --query | grep "HDMI2 connected"; then
    ...
    # xrandr --auto --output "HDMI2" --dpi 96 --mode "1920x1080" --output "eDP1" --off --auto --output "HDMI1" --mode "1920x1080" --left-of "HDMI2"
  fi
  ...
  if xrandr --query | grep "HDMI-2 connected"; then
    ...
    # xrandr --auto --output "HDMI-2" --dpi 96 --mode "1920x1080" --output "eDP-1" --off --auto --output "HDMI-1" --mode "1920x1080" --left-of "HDMI-2"
  fi
